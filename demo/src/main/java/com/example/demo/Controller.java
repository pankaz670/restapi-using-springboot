...
@RestController
@RequestMapping(path = "/employeesStorage")
public class Controller {
    ...
    public EmployeesStorage getEmployees() {
        return employeeDao.getAllEmployeesStorage();
    }
    ...
    public ResponseEntity<Object> addEmployee(
        ...
        int id = employeeDao.getAllEmployeesStorage().getEmployeeList().size() + 1;
        employee.setId(id);
